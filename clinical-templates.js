  ...
  const groups = [
    ...
    },
    {
      ...
      checklists: [
        ...
        cl('nsclc-adjuvant', '術後個案確認手術切緣、病理分期、腫瘤大小、淋巴結與術前治療內容', '確認'),
      ],
      precisionFields: [
        pf('nsclc-histology', 'NSCLC 組織型', 'single_select', ['腺癌','鱗狀細胞癌','大細胞／其他','NSCLC NOS','待確認']),
        pf('nsclc-drivers', 'NSCLC 驅動基因／可標靶變異', 'multi_select', ['EGFR exon 19 deletion','EGFR L858R','EGFR sensitizing（型別待確認）','EGFR exon 20 insertion','ALK fusion','ROS1 fusion','BRAF V600E','KRAS G12C','MET exon 14 skipping','MET amplification','RET fusion','NTRK1/2/3 fusion','ERBB2（HER2）mutation','NRG1 fusion','無已知可標靶變異','待檢']),
        ...
        pf('nsclc-surgery-path', 'NSCLC 手術／術前治療情境', 'single_select', ['先手術（未接受術前全身治療）','術前化療後手術','術前免疫治療＋化療後手術','尚未完成手術','待確認']),
        pf('nsclc-path-stage', 'NSCLC 術後病理分期', 'single_select', ['IA1','IA2','IA3','IB','IIA','IIB','IIIA','IIIB（已切除）','待確認']),
        pf('nsclc-pt', 'NSCLC 病理 T 分期', 'single_select', ['pTmi','pT1a','pT1b','pT1c','pT2a','pT2b','pT3','pT4','ypT0','ypT1','ypT2','ypT3','ypT4','待確認']),
        pf('nsclc-pn', 'NSCLC 病理 N 分期', 'single_select', ['pN0','pN1','pN2a','pN2b','pN3','ypN0','ypN1','ypN2','ypN3','待確認']),
        pf('nsclc-margin', 'NSCLC 手術切緣', 'single_select', ['R0（陰性）','R1（顯微陽性）','R2（肉眼殘存）','待確認']),
        pf('nsclc-tumor-size-cm', 'NSCLC 病理腫瘤最大徑（cm）', 'number'),
        pf('nsclc-high-risk', 'NSCLC 術後高風險特徵', 'multi_select', ['低分化／高分級','血管侵犯','楔狀切除','臟層胸膜侵犯','Nx／淋巴結評估不足','無上述特徵','待確認'], 'cancer', { exclusiveOptions: ['無上述特徵','待確認'] }),
        pf('nsclc-cisplatin', 'Cisplatin 適用性', 'single_select', ['適合 cisplatin','不適合 cisplatin','待確認']),
      ],
    },
    {
      ids: ['sclc'],
    ...
    },
    {
      ...
      precisionFields: [
        ...
        pf('crc-extended-markers', 'CRC 其他可作用標記', 'multi_select', ['HER2 amplification／overexpression','KRAS G12C','NTRK fusion','POLE／POLD1 pathogenic alteration','PIK3CA exon 9／20 mutation','其他 PIK3CA／PIK3R1 mutation','PTEN mutation／deep deletion','無','待檢']),
        pf('crc-metastatic-sites', '轉移部位', 'multi_select', ['肝','肺','腹膜','非區域淋巴結','骨','腦','其他','無']),
      ],
    },
    {
      ids: ['colon_cancer'],
      checklists: [cl('colon-adjuvant', '結腸癌術後確認 pT／pN、MMR／MSI、淋巴結數與 Stage II 高風險特徵', '確認')],
      precisionFields: [
        pf('colon-surgery-path', '結腸癌手術／術前治療情境', 'single_select', ['先手術','術前 FOLFOX／CAPEOX 後手術','尚未完成切除','待確認']),
        pf('colon-neoadjuvant-regimen', '結腸癌術前化療方案', 'single_select', ['FOLFOX','CAPEOX','其他','未接受術前化療','待確認'], 'cancer', { help: '只有選擇「術前 FOLFOX／CAPEOX 後手術」時需填；用來避免術後重新計算一套完整療程。' }),
        pf('colon-neoadjuvant-cycles', '結腸癌術前化療已完成週期數', 'number', [], 'cancer', { help: '請依實際病歷輸入；App 不會只依 ypStage 推測已完成療程。' }),
        pf('colon-path-stage', '結腸癌術後病理分期', 'single_select', ['0','I','IIA','IIB','IIC','IIIA','IIIB','IIIC','待確認']),
        pf('colon-pt', '結腸癌病理 T 分期', 'single_select', ['pTis','pT1','pT2','pT3','pT4a','pT4b','ypT0','ypT1','ypT2','ypT3','ypT4a','ypT4b','待確認']),
        pf('colon-pn', '結腸癌病理 N 分期', 'single_select', ['pN0','pN1a','pN1b','pN1c','pN2a','pN2b','ypN0','ypN1','ypN2','待確認']),
        pf('colon-margin', '結腸癌手術切緣', 'single_select', ['陰性','close／indeterminate','陽性','待確認']),
        pf('colon-nodes-examined', '結腸癌檢查淋巴結數', 'number'),
        pf('colon-high-risk', '結腸癌 Stage II 高風險特徵', 'multi_select', ['T4','低分化／未分化','淋巴／血管侵犯','腸阻塞','少於 12 顆淋巴結','神經周圍侵犯（PNI）','局部穿孔','close／indeterminate／positive margin','high-tier tumor budding','無上述特徵','待確認'], 'cancer', { exclusiveOptions: ['無上述特徵','待確認'] }),
      ],
    },
    {
      ids: ['rectal_cancer'],
      checklists: [cl('rectal-adjuvant', '直腸癌術後確認術前治療內容、pT／pN、CRM／切緣與全程治療長度', '確認')],
      precisionFields: [
        pf('rectal-surgery-path', '直腸癌手術／術前治療情境', 'single_select', ['經肛門局部切除','先做經腹切除','完成 TNT 後手術','術前化放療後手術（未完成 TNT）','免疫治療後完全臨床反應／未手術','尚未完成手術','待確認']),
        pf('rectal-path-stage', '直腸癌術後病理分期', 'single_select', ['0','I','IIA','IIB','IIC','IIIA','IIIB','IIIC','待確認']),
        pf('rectal-pt', '直腸癌病理 T 分期', 'single_select', ['pTis','pT1','pT2','pT3','pT4a','pT4b','ypT0','ypT1','ypT2','ypT3','ypT4a','ypT4b','待確認']),
        pf('rectal-pn', '直腸癌病理 N 分期', 'single_select', ['pNX','pN0','pN1','pN2','ypN0','ypN1','ypN2','待確認']),
        pf('rectal-margin', '直腸癌切緣', 'single_select', ['陰性','close／indeterminate','陽性','待確認']),
        pf('rectal-crm', '直腸癌環周切緣（CRM）', 'single_select', ['陰性／未受威脅','受威脅（≤1 mm）','陽性','不適用／待確認']),
        pf('rectal-location', '直腸腫瘤位置', 'single_select', ['上段直腸','中段直腸','下段直腸','待確認']),
        pf('rectal-differentiation', '直腸癌分化程度', 'single_select', ['高分化','中分化','低分化／未分化','待確認'], 'cancer', { help: 'pT3N0 上段直腸要考慮 observation 時，須確認為高分化或中分化。' }),
        pf('rectal-mesorectal-invasion-mm', 'pT3 進入直腸系膜深度（mm）', 'number', [], 'cancer', { help: '只有 pT3N0 上段直腸的 observation 判斷需要；NCCN 原頁門檻為小於 2 mm。' }),
        pf('rectal-mesorectal-grade', '直腸系膜切除品質', 'single_select', ['complete','nearly complete','incomplete','待確認']),
        pf('rectal-high-risk', '直腸癌術後高風險特徵', 'multi_select', ['淋巴／血管侵犯','低分化','神經周圍侵犯（PNI）','EMVI','陽性／受威脅 CRM','incomplete mesorectal grade','無上述特徵','待確認'], 'cancer', { exclusiveOptions: ['無上述特徵','待確認'] }),
      ],
    },
    {
